...
public class DevelopmentCard {
     ...
     */
    public DevelopmentCard(DevelopmentCardColor color, int level, Map<Resource, Integer> price, int victoryPoints, PowerOfProduction powerOfProduction) throws InvalidParameterException {
